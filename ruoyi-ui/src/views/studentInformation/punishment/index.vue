<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="处罚" prop="levels">
        <el-input
      ...
      <el-form-item label="是否生效" prop="enable">
        <el-select v-model="queryParams.enable" placeholder="请选择是否生效" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:punishment:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:punishment:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:punishment:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:punishment:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="punishmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="处罚" align="center" prop="levels" />
      ...
      <el-table-column label="是否生效" align="center" prop="enable">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_yes_no" :value="scope.row.enable"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="处罚" prop="levels">
          <el-input v-model="form.levels" placeholder="请输入处罚" />
        </el-form-item>
        <el-form-item label="记录时间" prop="recTime">
          <el-date-picker clearable
...
<script>
import { listPunishment, getPunishment, delPunishment, addPunishment, updatePunishment } from "@/api/studentInformation/punishiment/api";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除处罚表编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/punishment/export', {
        ...this.queryParams
