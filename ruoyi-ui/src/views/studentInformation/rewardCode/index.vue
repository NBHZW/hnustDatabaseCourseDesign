...
<script>
import { listCode, getCode, delCode, addCode, updateCode } from "@/api/studentInformation/rewardCode/api";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除奖励等级代码编号为"' + codes + '"的数据项？').then(function() {
