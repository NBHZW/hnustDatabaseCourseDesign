<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="departmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="院名" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="院名" prop="name">
          <el-input v-model="form.name" placeholder="请输入院名" />
        </el-form-item>
      </el-form>
...
<script>
import { listDepartment, getDepartment, delDepartment, addDepartment, updateDepartment } from "@/api/studentInformation/department/api";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "院名不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除院系信息编号为"' + ids + '"的数据项？').then(function() {
