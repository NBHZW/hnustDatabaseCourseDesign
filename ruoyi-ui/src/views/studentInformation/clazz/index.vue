<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="班级全称" prop="name">
        <el-input
      ...
      <el-form-item label="班长学号" prop="monitor">
        <el-input
    ...
    <el-table v-loading="loading" :data="clazzList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="班级全称" align="center" prop="name" />
      <el-table-column label="班长学号" align="center" prop="monitor" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="班级全称" prop="name">
          <el-input v-model="form.name" placeholder="请输入班级全称" />
        </el-form-item>
        <el-form-item label="班长学号" prop="monitor">
          <el-input v-model="form.monitor" placeholder="请输入班长学号" />
        </el-form-item>
      </el-form>
...
<script>
import { listClazz, getClazz, delClazz, addClazz, updateClazz } from "@/api/studentInformation/clazz/api";
